...
describe 'My behaviour' do
  it 'Cell Fill Color' do
    ...
    expect(xlsx.worksheets.first.rows.first.cells.first.style.fill_color.pattern_fill.foreground_color).to eq(OoxmlParser::Color.new(197, 224, 180))
  end
  ...
  it 'cell_style_fill_color_0.5' do
    ...
    expect(xlsx.worksheets.first.rows.first.cells.first.style.fill_color.pattern_fill.foreground_color).to eq(OoxmlParser::Color.new(127, 127, 127))
  end
  ...
  it 'cell_style_fill_color_0.35' do
    ...
    expect(xlsx.worksheets.first.rows.first.cells.first.style.fill_color.pattern_fill.foreground_color).to eq(OoxmlParser::Color.new(89, 89, 89))
  end
  ...
  it 'cell_style_fill_color_0_theme_0' do
    ...
    expect(xlsx.worksheets.first.rows.first.cells.first.style.fill_color.pattern_fill.foreground_color).to eq(OoxmlParser::Color.new(255, 255, 255))
  end
  ...
  it 'cell_style_fill_color_0_theme_1' do
    ...
    expect(xlsx.worksheets.first.rows.first.cells.first.style.fill_color.pattern_fill.foreground_color).to eq(OoxmlParser::Color.new(0, 0, 0))
  end
