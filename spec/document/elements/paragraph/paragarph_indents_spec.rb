...
describe OoxmlParser::Indents do
  ...
  it 'indents_comparasion' do
    ...
    expect(docx.element_by_description.first.ind).to eq(OoxmlParser::Indents.new(OoxmlParser::OoxmlSize.new(0, :centimeter), OoxmlParser::OoxmlSize.new(1.27, :centimeter), OoxmlParser::OoxmlSize.new(0, :centimeter)))
  end
end
