...
describe 'formula' do
  ...
  describe 'type' do
    ...
    it 'formula_bar_1.docx' do
      docx = OoxmlParser::DocxParser.parse_docx('spec/document/elements/formula/types/formula_bar_1.docx')
      expect(docx.elements.first.nonempty_runs.first).to be_a(OoxmlParser::DocxFormula)
    end

    it 'formula_bar_2.docx' do
      docx = OoxmlParser::DocxParser.parse_docx('spec/document/elements/formula/types/formula_bar_2.docx')
      expect(docx.elements.first.nonempty_runs.first).to be_a(OoxmlParser::DocxFormula)
    end
